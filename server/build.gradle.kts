...
dependencies {
    implementation("com.timgroup:Tucker:1.0.1555") // autobump
    ...
    implementation("com.timgroup:eventstore-api:0.0.2025") // autobump
    implementation("com.timgroup:eventstore-filesystem:0.0.2025") // autobump
    ...
    testImplementation("com.timgroup:eventstore-memory:0.0.2025") // autobump
