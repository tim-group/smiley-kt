...
dependencies {
    implementation("com.timgroup:Tucker:1.0.1584") // autobump
    ...
    implementation("com.timgroup:eventstore-api:0.0.2127") // autobump
    implementation("com.timgroup:eventstore-filesystem:0.0.2127") // autobump
    ...
    testImplementation("com.timgroup:eventstore-memory:0.0.2127") // autobump
