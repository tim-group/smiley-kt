...
dependencies {
    ...
    implementation("com.timgroup:tim-jetty:1.0.17") // autobump
    ...
    implementation("com.timgroup:eventstore-api:0.0.2074") // autobump
    implementation("com.timgroup:eventstore-filesystem:0.0.2074") // autobump
    ...
    testImplementation("com.timgroup:eventstore-memory:0.0.2074") // autobump
