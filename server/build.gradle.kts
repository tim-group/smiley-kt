...
dependencies {
    implementation("com.timgroup:Tucker:1.0.1572") // autobump
    ...
    implementation("com.timgroup:eventstore-api:0.0.2057") // autobump
    implementation("com.timgroup:eventstore-filesystem:0.0.2057") // autobump
    ...
    testImplementation("com.timgroup:eventstore-memory:0.0.2057") // autobump
