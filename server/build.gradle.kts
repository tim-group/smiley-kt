...
dependencies {
    ...
    implementation("com.timgroup:tim-jetty:1.0.24") // autobump
    ...
    implementation("com.timgroup:eventstore-api:0.0.2092") // autobump
    implementation("com.timgroup:eventstore-filesystem:0.0.2092") // autobump
    ...
    testImplementation("com.timgroup:eventstore-memory:0.0.2092") // autobump
