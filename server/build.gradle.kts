...
dependencies {
    ...
    implementation("com.timgroup:eventstore-api:0.0.1954") // autobump
    implementation("com.timgroup:eventstore-filesystem:0.0.1954") // autobump
    ...
    testImplementation("com.timgroup:eventstore-memory:0.0.1954") // autobump
