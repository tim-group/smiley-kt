...
dependencies {
    ...
    implementation("com.timgroup:tim-logger:1.5.1104") // autobump
    implementation("com.timgroup:tim-structured-events:0.4.1284") // autobump
    implementation("com.timgroup:eventstore-api:0.0.2013") // autobump
    implementation("com.timgroup:eventstore-filesystem:0.0.2013") // autobump
    ...
    testImplementation("com.timgroup:eventstore-memory:0.0.2013") // autobump
