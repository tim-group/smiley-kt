...
dependencies {
    ...
    implementation("com.timgroup:eventstore-api:0.0.1994") // autobump
    implementation("com.timgroup:eventstore-filesystem:0.0.1994") // autobump
    ...
    testImplementation("com.timgroup:eventstore-memory:0.0.1994") // autobump
