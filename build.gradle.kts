...
val kotlinStdlibJsVersion by extra("1.2.31")
...
dependencies {
    ...
    compile("com.timgroup:eventstore-api:0.0.1590") // autobump
    compile("com.timgroup:eventstore-filesystem:0.0.1590") // autobump
    ...
    testCompile("com.timgroup:eventstore-memory:0.0.1590") // autobump
