...
dependencies {
    ...
    compile("com.timgroup:eventstore-api:0.0.1562") // autobump
    compile("com.timgroup:eventstore-filesystem:0.0.1562") // autobump
    ...
    testCompile("com.timgroup:eventstore-memory:0.0.1562") // autobump
