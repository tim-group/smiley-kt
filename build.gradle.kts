...
dependencies {
    compile("com.timgroup:Tucker:1.0.1498") // autobump
    compile("com.timgroup:tim-logger:1.5.1087") // autobump
    compile("com.timgroup:tim-structured-events:0.4.1239") // autobump
    compile("com.timgroup:eventstore-api:0.0.1598") // autobump
    compile("com.timgroup:eventstore-filesystem:0.0.1598") // autobump
    ...
    testCompile("com.timgroup:tim-structured-events-testing:0.4.1239") // autobump
    testCompile("com.timgroup:eventstore-memory:0.0.1598") // autobump
