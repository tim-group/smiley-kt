...
dependencies {
    ...
    compile("com.timgroup:tim-structured-events:0.4.1266") // autobump
    compile("com.timgroup:eventstore-api:0.0.1825") // autobump
    compile("com.timgroup:eventstore-filesystem:0.0.1825") // autobump
    ...
    testCompile("com.timgroup:tim-structured-events-testing:0.4.1266") // autobump
    testCompile("com.timgroup:eventstore-memory:0.0.1825") // autobump
    testCompile("org.apache.httpcomponents:httpclient:4.5.5")
    testCompile("com.timgroup:clocks-testing:1.0.1096") // autobump
