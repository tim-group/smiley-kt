...
dependencies {
    compile("com.timgroup:Tucker:1.0.1542") // autobump
    compile("com.timgroup:tim-logger:1.5.1101") // autobump
    compile("com.timgroup:tim-structured-events:0.4.1275") // autobump
    compile("com.timgroup:eventstore-api:0.0.1907") // autobump
    compile("com.timgroup:eventstore-filesystem:0.0.1907") // autobump
    ...
    testCompile("com.timgroup:tim-structured-events-testing:0.4.1275") // autobump
    testCompile("com.timgroup:eventstore-memory:0.0.1907") // autobump
    testCompile("org.apache.httpcomponents:httpclient:4.5.5")
    testCompile("com.timgroup:clocks-testing:1.0.1104") // autobump
