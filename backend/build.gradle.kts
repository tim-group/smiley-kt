...
dependencies {
    ...
    compile("com.timgroup:eventstore-api:0.0.1824") // autobump
    compile("com.timgroup:eventstore-filesystem:0.0.1824") // autobump
    ...
    testCompile("com.timgroup:eventstore-memory:0.0.1824") // autobump
