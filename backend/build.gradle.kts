...
dependencies {
    ...
    compile("com.timgroup:eventstore-api:0.0.1882") // autobump
    compile("com.timgroup:eventstore-filesystem:0.0.1882") // autobump
    ...
    testCompile("com.timgroup:eventstore-memory:0.0.1881") // autobump
