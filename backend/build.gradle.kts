...
dependencies {
    ...
    compile("com.timgroup:eventstore-api:0.0.1677") // autobump
    compile("com.timgroup:eventstore-filesystem:0.0.1677") // autobump
    ...
    testCompile("com.timgroup:eventstore-memory:0.0.1677") // autobump
