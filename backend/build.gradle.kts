...
dependencies {
    compile("com.timgroup:Tucker:1.0.1526") // autobump
    compile("com.timgroup:tim-logger:1.5.1096") // autobump
    compile("com.timgroup:tim-structured-events:0.4.1263") // autobump
    compile("com.timgroup:eventstore-api:0.0.1778") // autobump
    compile("com.timgroup:eventstore-filesystem:0.0.1778") // autobump
    ...
    testCompile("com.timgroup:eventstore-memory:0.0.1778") // autobump
