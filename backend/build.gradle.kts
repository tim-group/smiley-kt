...
dependencies {
    compile("com.timgroup:Tucker:1.0.1514") // autobump
    compile("com.timgroup:tim-logger:1.5.1094") // autobump
    compile("com.timgroup:tim-structured-events:0.4.1251") // autobump
    compile("com.timgroup:eventstore-api:0.0.1668") // autobump
    compile("com.timgroup:eventstore-filesystem:0.0.1668") // autobump
    ...
    testCompile("com.timgroup:eventstore-memory:0.0.1668") // autobump
