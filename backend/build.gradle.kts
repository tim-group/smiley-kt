...
dependencies {
    compile("com.timgroup:Tucker:1.0.1523") // autobump
    compile("com.timgroup:tim-logger:1.5.1095") // autobump
    compile("com.timgroup:tim-structured-events:0.4.1261") // autobump
    compile("com.timgroup:eventstore-api:0.0.1762") // autobump
    compile("com.timgroup:eventstore-filesystem:0.0.1762") // autobump
    ...
    testCompile("com.timgroup:eventstore-memory:0.0.1762") // autobump
