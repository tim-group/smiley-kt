...
dependencies {
    ...
    compile("com.timgroup:eventstore-api:0.0.1783") // autobump
    compile("com.timgroup:eventstore-filesystem:0.0.1783") // autobump
    ...
    testCompile("com.timgroup:eventstore-memory:0.0.1783") // autobump
    testCompile("org.apache.httpcomponents:httpclient:4.5.5")
    testCompile("com.timgroup:clocks-testing:1.0.1093") // autobump
