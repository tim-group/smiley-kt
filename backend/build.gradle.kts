...
dependencies {
    compile("com.timgroup:Tucker:1.0.1545") // autobump
    compile("com.timgroup:tim-logger:1.5.1101") // autobump
    compile("com.timgroup:tim-structured-events:0.4.1281") // autobump
    compile("com.timgroup:eventstore-api:0.0.1940") // autobump
    compile("com.timgroup:eventstore-filesystem:0.0.1940") // autobump
    ...
    testCompile("com.timgroup:eventstore-memory:0.0.1940") // autobump
