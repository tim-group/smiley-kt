...
dependencies {
    compile("com.timgroup:Tucker:1.0.1532") // autobump
    compile("com.timgroup:tim-logger:1.5.1097") // autobump
    compile("com.timgroup:tim-structured-events:0.4.1268") // autobump
    compile("com.timgroup:eventstore-api:0.0.1835") // autobump
    compile("com.timgroup:eventstore-filesystem:0.0.1835") // autobump
    ...
    testCompile("com.timgroup:eventstore-memory:0.0.1835") // autobump
